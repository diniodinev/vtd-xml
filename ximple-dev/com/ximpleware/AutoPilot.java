...
public class AutoPilot {
	...
	/**
	 * Select the element name before iterating. "*" matches every element
	...
	/**
	 * Select the element name (name space version) before iterating. URL, if
	 * set to *, matches every namespace URL, if set to null, indicates the
	 * namespace is undefined. localname, if set to *, matches any localname
	...
	/**
	 * Select all descendent elements along the descendent axis, without ns
	 * awareness
	 * 
	 * @param en
	 */
	...
	/**
	 * Select all elements along the following axis, without ns, null selects
	 * every elements and documents
	 * 
	 * @param en
	 */
	...
	/**
	 * Select all elements along the following axis as defined in XPath The
	...
	protected void selectElement_P(String en) {
		if (en == null)
			throw new IllegalArgumentException("element name can't be null");
		// depth =
		// (vn.atTerminal)?(vn.getCurrentDepth()+1):vn.getCurrentDepth();
		iter_type = PRECEDING;
		ft = true;
		name = en;
	...
	/**
	 * Select all elements along the preceding axis as defined in XPath This is
